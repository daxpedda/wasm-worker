...
globalThis.registerProcessor('__web_thread_worklet', class extends AudioWorkletProcessor {
    constructor(__web_thread_options) {
        ...
        __web_thread_worklet_register(__web_thread_data)

        this.continueProcessing = true
        this.port.onmessage = (__web_thread_event) => {
            ...
            if (__web_thread_task === undefined)
                return

            __web_thread_worklet_entry(__web_thread_task, __web_thread_message, __web_thread_event.ports[0])
        }
    }
