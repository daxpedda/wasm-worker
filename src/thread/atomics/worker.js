self.onmessage = async __web_thread_event => {
	...
	const [__web_thread_module, __web_thread_memory, __web_thread_task] = __web_thread_event.data

	initSync(__web_thread_module, __web_thread_memory)
	const __web_thread_terminate_index = await __web_thread_worker_entry(__web_thread_task)
