self.registerProcessor('__wasm_worker_InitWasm', class __wasm_worker_InitWasm extends AudioWorkletProcessor {
	constructor(__wasm_worker_options) {
		...
		__wasm_worker_worklet_entry(__wasm_worker_data);
	}
